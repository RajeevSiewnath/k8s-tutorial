...
kubectl set image deployments/client-deployments client=rajeevsiewnath/multi-client:$SHA
kubectl set image deployments/server-deployments server=rajeevsiewnath/multi-server:$SHA
kubectl set image deployments/worker-deployments worker=rajeevsiewnath/multi-worker:$SHA